...
export default function (props) {
  const meta = {
    title: "Alexa Theater Room",
    author: "Drew B.",
    twitter: "@boxcardrew",
    description: "Getting started with Alexa Audio/Video",
    date: "August 04, 2020",
    stars: 2,
    tags: ["Alexa", "Featured", "Logitech"],
    items: [2407, 2423, 2458, 2459, 2462, 2401],
    total: 445,
    slug: 'alexa-home-theater',
  };
